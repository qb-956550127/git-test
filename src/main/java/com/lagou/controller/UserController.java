...
public class UserController {
    ...
    //@PreAuthorize("#id<3")//针对方法参数权限控制 只有id<3的才能访问
    ...
    @GetMapping("/{id}")
    @ResponseBody
    //@PostAuthorize("returnObject.username==authentication.principal.username")//returnObject返回参数，只能自己查询自己
    public User getById(@PathVariable Integer id) {
        //获取认证的信息
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        //如果返回true 代表这个登录认证的信息来源于自动登录  例如开启remember-me
